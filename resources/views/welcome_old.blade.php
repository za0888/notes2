    ...
    <body class="antialiased">
        <div class="relative h-8 flex items-top justify-center dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            @endif
                ...
                <div class="flex justify-center flex-wrap w-full bg-blue-700 gap-10 mt-4  p-8">

                    @foreach ($teams as $team )
                    <div class="flex flex-1 flex-col basis-80">
                        <section class="basis-80 shadow-xl shadow-gray-500 p-8 bg-gray-300">

                            <a href="{{ route('register',$team->id) }}"
                               class="block w-full h-full text-black p-8 prose lg:prose-xl mb-8">
